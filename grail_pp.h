...
#define GRAIL_PP_0LTR(x...) GRAIL_PP_0PSTR(x)
...
(,,GRAIL_PP_SCAN(GRAIL_PP_0VARG_SORT GRAIL_PP_EMPTY (GRAIL_PP_0VARG_FILTER_AUX(GRAIL_PP_0GQT,x,xs))) \
,x \
,GRAIL_PP_SCAN(GRAIL_PP_0VARG_SORT GRAIL_PP_EMPTY(GRAIL_PP_0VARG_FILTER_AUX(GRAIL_PP_0LT,x,xs))))
